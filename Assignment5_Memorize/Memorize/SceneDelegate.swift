...
class ThemeStorage {
    ...
    init() {
        let animals = Theme(name: "Animals", emojies: ["🐼", "🐔","🦄", "🦕", "🦨"], color: .yellow, numberToShow: 2)
        let sports = Theme(name: "Sports", emojies: [ "🏀", "🏈", "⚾", "🥎", "🎽"], color: .red, numberToShow: 3)
        let faces = Theme(name: "Faces", emojies: ["😀", "😢", "😉", "😓", "☹️", "😱"], color: .green, numberToShow: 5)
